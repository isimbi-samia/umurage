...
import {
  ...
  Loader2, CheckCircle, CloudUpload, Play, Pause, ZoomIn, AlertCircle
} from 'lucide-react';
...
const CONTENT_TYPES = [
  { value: 'video', label: 'Video', icon: Video, desc: 'Traditional dances, ceremonies, documentaries', accept: 'video/*', maxMB: 50 },
  ...
  { value: 'book', label: 'Book / PDF', icon: BookOpen, desc: 'Research papers, history books, articles', accept: '.pdf,.doc,.docx', maxMB: 20 },
